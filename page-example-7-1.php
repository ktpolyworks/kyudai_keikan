...
get_header(); ?>
	...
	<main class="work-main" data-url="<?php print get_template_directory_uri(); ?>/">
		...
		<table class="section__sub__image">
					<tr>
						<td class="td1 imgLiquid"><img src="<?php print get_template_directory_uri(); ?>/img/works/example/11-2+.jpg"></td>
						<td class="td1 imgLiquid"><img src="<?php print get_template_directory_uri(); ?>/img/works/example/11-3.jpg"></td>
					</tr>
					<tr>
						<td class="td4">▲<br>視覚障がい者にお願いして、国際杉板材、コンクリート、アスファルト等を白杖で叩いた際の音を聴いていただき、音の違いが明確にわかるかどうかの試験（官能試験）を実施しました。最終的に101名の方にご協力いただきましたが、そのうち98名が「音を識別できる」と回答され、音響の違いによる場の識別が可能であることを確認できました。</td>
						<td class="td4">▲<br>九大伊都キャンパス内に試験歩道を造成し、そこを視覚障がい者に歩いていただくことで、実際の屋外空間を歩行する際に音響の違いによる場の識別が可能かどうかを検証しました。試験歩道は木製部分とアスファルト部分の各９メートルからなっています。九州各地から43名の方にご協力いただくことができ、試験の結果、木製部分で車道に飛び出した方は一人もおられず、木製バリアフリー歩道には高い実現性があることを確認することができました。</td>
					</tr>
		</table>
			</div>
		</section>
