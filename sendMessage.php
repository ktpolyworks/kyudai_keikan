...
$from_email = 'noreply@lsd.or.jp';
$from_name  = '一般社団法人LSD サスティナブルデザインラボ';
$post       = [];
...
if($v1 == '' || $v2 == '' || $v3 == '' || $v4 == ''){
	...
	$email    = $v2;
	$subject  = 'お問い合わせを受け付けました 【一般社団法人LSD サスティナブルデザインラボ】';
$message1     = <<< MSG
こちらは一般社団法人LSD サスティナブルデザインラボです。
...
$message2     = <<< MSG
こちらは一般社団法人LSD サスティナブルデザインラボウェブサイトです。
